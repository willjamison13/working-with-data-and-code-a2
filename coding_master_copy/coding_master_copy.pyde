...
# Define colours for the Olympic rings in RGB format
ring_colors = [
...
# Define three offset colours for the "A" — this creates a multicolored 3D-like effect
a_colors = [
...
def setup():
    ...
    size(1000, 900)        # Set the canvas to 1000x900 pixels
